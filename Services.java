...
public class Services {
	...
	public static void sendMail(String emailid,int otp){
		final String username  = "acharyarchana1@gmail.com";//Sender Email
		final String password   = "axexazjxlqgzgcfc";//Sender Password
	...
	public static void sendMail1(String emailid,String pass){
		final String username  = "acharyarchana1@gmail.com";
		final String password   = "@@ACHARYARCHANA@@";
